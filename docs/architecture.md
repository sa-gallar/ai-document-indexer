...
* **Фронтенд (��раузер):** Отвечает исключительно за отображение интерфейса, прогресс-бара и таблиц. Не хранит состояние обработки и не кэширует результаты ИИ-обработки.
...
4. **Бэкенд возвращает текущее состояние:**
   - Количество обработа��ных файлов
...
| Термин | Определение |
|---|---|
| **Ск��нер** | Компонент, который рекурсивно обходит файловую систему и собирает метаданные о найденных файлах поддерживаемых форматов. |
...
👉 **[Модель данн��х (Data Model)](data-model.md)** — структуры входных и выходных данных  
