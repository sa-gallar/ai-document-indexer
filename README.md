...
* 🔒 **[Политика безопасности и Disclaimer](docs/security-policy.md)** — разграничение ответственности при работе с персональными данными (ПДн) и конфиденциальной информацией.
