...
---
## 📂 Навигация по документации проекта (Ссылки)
* 👥 **[Требования и Пользовательские истории](docs/user-stories.md)** — подробные User Stories и критерии приемки (QA).
* 🗺️ **[Архитектура и Workflow процесса](docs/architecture.md)** — UML-диаграмма последовательности взаимодействия системы с ИИ.
* 🤖 **[Системный промпт для ИИ](docs/system-prompt.md)** — готовый Prompt инженерный шаблон с техникой Chain-of-Thought.
